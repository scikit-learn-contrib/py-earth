...
static PyObject *__pyx_pf_7pyearth_5_util_gcv(CYTHON_UNUSED PyObject *__pyx_self, __pyx_t_7pyearth_5_util_FLOAT_t __pyx_v_mse, unsigned int __pyx_v_basisSize, unsigned int __pyx_v_dataSize, __pyx_t_7pyearth_5_util_FLOAT_t __pyx_v_penalty); /* proto */
...
static char __pyx_k__dataSize[] = "dataSize";
...
static PyObject *__pyx_n_s__dataSize;
...
static CYTHON_INLINE __pyx_t_7pyearth_5_util_FLOAT_t __pyx_f_7pyearth_5_util_gcv(__pyx_t_7pyearth_5_util_FLOAT_t __pyx_v_mse, unsigned int __pyx_v_basisSize, unsigned int __pyx_v_dataSize, __pyx_t_7pyearth_5_util_FLOAT_t __pyx_v_penalty, CYTHON_UNUSED int __pyx_skip_dispatch) {
 ...
 * 
 */
  __pyx_t_1 = (__pyx_v_basisSize + (__pyx_v_penalty * (__pyx_v_basisSize - 1)));
  if (unlikely(__pyx_v_dataSize == 0)) {
    PyErr_Format(PyExc_ZeroDivisionError, "float division");
    {__pyx_filename = __pyx_f[0]; __pyx_lineno = 6; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_t_2 = pow((1.0 - (__pyx_t_1 / __pyx_v_dataSize)), 2.0);
...
static PyObject *__pyx_pw_7pyearth_5_util_1gcv(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  unsigned int __pyx_v_basisSize;
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s__mse,&__pyx_n_s__basisSize,&__pyx_n_s__dataSize,&__pyx_n_s__penalty,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        case  1:
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__basisSize)) != 0)) kw_args--;
        else {
        ...
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__dataSize)) != 0)) kw_args--;
        else {
    ...
    __pyx_v_basisSize = __Pyx_PyInt_AsUnsignedInt(values[1]); if (unlikely((__pyx_v_basisSize == (unsigned int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 5; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_dataSize = __Pyx_PyInt_AsUnsignedInt(values[2]); if (unlikely((__pyx_v_dataSize == (unsigned int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 5; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  ...
  __pyx_r = __pyx_pf_7pyearth_5_util_gcv(__pyx_self, __pyx_v_mse, __pyx_v_basisSize, __pyx_v_dataSize, __pyx_v_penalty);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
}
...
static PyObject *__pyx_pf_7pyearth_5_util_gcv(CYTHON_UNUSED PyObject *__pyx_self, __pyx_t_7pyearth_5_util_FLOAT_t __pyx_v_mse, unsigned int __pyx_v_basisSize, unsigned int __pyx_v_dataSize, __pyx_t_7pyearth_5_util_FLOAT_t __pyx_v_penalty) {
  ...
  __pyx_t_1 = PyFloat_FromDouble(__pyx_f_7pyearth_5_util_gcv(__pyx_v_mse, __pyx_v_basisSize, __pyx_v_dataSize, __pyx_v_penalty, 0)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 5; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s__dataSize, __pyx_k__dataSize, sizeof(__pyx_k__dataSize), 0, 0, 1, 1},
